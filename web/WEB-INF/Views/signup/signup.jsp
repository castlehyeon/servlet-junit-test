...
<table class="table table-striped"
    ...
    <tr>
        ...
        <td style="width: 700px">
            <form action="/registerok.signup" method="post" name="joinForm" id="joinForm">
                ...
                <div>
                    <table
                        ...
                        <tr>
                            <th>Name:</th>
                            <td><input class="form-control form-control-lg" type="text" name="name" id="name"></td>
                        </tr>
                        <tr>
                            <th>age:</th>
                            <td><input class="form-control form-control-lg" type="text" name="age" id="age" maxlength="3"></td>
                        </tr>
                        <tr>
                            <th>Gender:</th>
                            <td><input class="form-check" type="radio" name="gender" id="gender" value="여"
                                       checked>여자 <input type="radio" name="gender"
                                                         id="gender" value="남">남자</td>
                        </tr>
                        <tr>
                            <th>Email:</th>
                            <td><input class="form-control form-control-lg" type="text" name="email" id="email"></td>
                        </tr>
                        <tr>
                            <td colspan="2">
